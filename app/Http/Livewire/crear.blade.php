                        ...
                        <form>
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="Nombre_articulo" wire:model="Nombre_articulo">
                                </div>
                                <div class="mb-4">
                                    <label for="Nombre_articulo">Descripcion Articulo</label>
                                    <input type="text" id="Descripcion_articulo" wire:model="Descripcion_articulo">
                                </div>
                                <div class="mb-4">
                                    <label for="Nombre_articulo">Cantidad Articulo</label>
                                    <input type="number" id="Cantidad_articulo" wire:model="Cantidad_articulo">
                                </div>
